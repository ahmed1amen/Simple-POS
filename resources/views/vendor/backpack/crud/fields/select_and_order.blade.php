            ...
            create: function (event, ui) {
                ...
                if (Object.keys($allOptions).length) {
                    ...
                    for (value in $allOptions) {
                        $dragSource.append('<li value="'+value+'"><i class="fa fa-arrows"></i> '+$allOptions[value]+'</li>');
                    }
                }
                ...
                if ($alreadySelectedOptions.length) {
                    ...
                    $alreadySelectedOptions.forEach(function(value, key) {
                        $dragDestination.append('<li value="'+value+'"><i class="fa fa-arrows"></i> '+$allOptions[value]+'</li>');
